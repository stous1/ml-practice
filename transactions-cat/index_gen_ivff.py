...
# Definir ruta del archivo CSV y del índice FAISS
csv_path = "dataset_transacciones_colombia.csv"
...
try:
    ...
    nlist = num_categories  # Número de clusters
    quantizer = faiss.IndexFlatL2(dimension)  # Utilizado para clustering
    index = faiss.IndexIVFFlat(quantizer, dimension, nlist, faiss.METRIC_L2)
    
    # Entrenar el índice
    train_start_time = time.time()
    index.train(embeddings)
    print(f"Índice entrenado en {time.time() - train_start_time:.2f} segundos")
